    ...
    <div class="min-h-screen p-6 bg-gray-200 flex items-center justify-center">
        <div class="container max-w-screen-lg mx-auto">
          <div>
            ...
            <p class="text-gray-800 mb-6 font-semibold">Create Your FluxRoute Business Account Now!</p>
            ...
            <div class="bg-white rounded shadow-lg p-4 px-4 md:p-8 mb-6">
              <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 lg:grid-cols-3">
                <div class="text-gray-700 font-semibold">
                  ...
                  <p>Sign up and experience a hassle-free package tracking and delivery scheduling.</p><br/>
