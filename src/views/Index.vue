	...
	<div class="navbar-menu relative z-50 hidden">
		...
		<nav class="fixed top-0 left-0 bottom-0 flex flex-col w-5/6 max-w-sm py-6 px-6 bg-white border-r overflow-y-auto">
			...
			<div>
				<ul>
					<li class="mb-1">
						<a class="block p-4 text-sm text-gray-800 font-semibold hover:text-gray-600 rounded">Home</a>
					</li>
					<li class="mb-1">
						<a class="block p-4 text-sm text-gray-800 font-semibold hover:text-gray-600 rounded">About Us</a>
					</li>
					<li class="mb-1">
						<a class="block p-4 text-sm text-gray-800 font-semibold hover:text-gray-600 rounded">Services</a>
					</li>
					<li class="mb-1">
						<a class="block p-4 text-sm text-gray-800 font-semibold hover:text-gray-600 rounded">Pricing</a>
					</li>
					<li class="mb-1">
						<a class="block p-4 text-sm text-gray-800 font-semibold hover:text-gray-600 rounded">Contact</a>
					</li>
				</ul>
			</div>
			<div class="mt-auto">
